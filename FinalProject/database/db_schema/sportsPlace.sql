...
(17, 'NFL', 'Las Vegas Raiders', 'OAK', 'AFC', 'West', ''),
(18, 'NFL', 'Los Angeles Chargers', 'SD', 'AFC', 'West', ''),
(19, 'NFL', 'Los Angeles Rams', 'STL', 'NFC', 'West', ''),
(20, 'NFL', 'Miami Dolphins', 'MIA', 'AFC', 'East', ''),
(21, 'NFL', 'Minnesota Vikings', 'MIN', 'NFC', 'North', ''),
(22, 'NFL', 'New England Patriots', 'NE', 'AFC', 'East', ''),
(23, 'NFL', 'New Orleans Saints', 'NO', 'NFC', 'South', ''),
(24, 'NFL', 'New York Giants', 'NYG', 'NFC', 'East', ''),
(25, 'NFL', 'New York Jets', 'NYJ', 'AFC', 'East', ''),
(26, 'NFL', 'Philadelphia Eagles', 'PHI', 'NFC', 'East', ''),
(27, 'NFL', 'Pittsburgh Steelers', 'PIT', 'AFC', 'North', ''),
(28, 'NFL', 'San Francisco 49ers', 'SF', 'NFC', 'West', ''),
(29, 'NFL', 'Seattle Seahawks', 'SEA', 'NFC', 'West', ''),
...
(94, 'MLS', 'Austin', '', 'West', '', ''),
(95, 'MLS', 'Charlotte', '', 'East', '', ''),
(96, 'MLS', 'Chicago Fire', '', 'East', '', ''),
(97, 'MLS', 'Colorado Rapids', '', 'West', '', ''),
(98, 'MLS', 'Columbus Crew', '', 'East', '', ''),
(99, 'MLS', 'DC United', '', 'East', '', ''),
(100, 'MLS', 'FC Cincinnati', '', 'East', '', ''),
(101, 'MLS', 'FC Dallas', '', 'West', '', ''),
(102, 'MLS', 'Houston Dynamo', '', 'West', '', ''),
(103, 'MLS', 'Inter Miami', '', 'East', '', ''),
(104, 'MLS', 'Los Angeles Galaxy', '', 'West', '', ''),
(105, 'MLS', 'Los Angeles FC', '', 'West', '', ''),
(106, 'MLS', 'Minnesota United FC', '', 'West', '', ''),
(107, 'MLS', 'Nashville SC', '', 'East', '', ''),
(108, 'MLS', 'New England Revolution', '', 'East', '', ''),
(109, 'MLS', 'New York City FC', '', 'East', '', ''),
(110, 'MLS', 'New York Red Bulls', '', 'East', '', ''),
(111, 'MLS', 'Orlando City SC', '', 'East', '', ''),
(112, 'MLS', 'Philadelphia Union', '', 'East', '', ''),
(113, 'MLS', 'Portland Timbers', '', 'West', '', ''),
(114, 'MLS', 'Real Salt Lake', '', 'West', '', ''),
(115, 'MLS', 'San Jose Earthquakes', '', 'West', '', ''),
(116, 'MLS', 'Seattle Sounders', '', 'West', '', ''),
(117, 'MLS', 'Sporting Kansas City', '', 'West', '', ''),
(118, 'MLS', 'St. Louis City', '', 'West', '', ''),
(119, 'MLS', 'Toronto FC', '', 'East', '', ''),
(120, 'MLS', 'Vancouver Whitecaps', '', 'West', '', '');